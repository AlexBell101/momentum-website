          ...
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <div id="security" className="mb-12">
              ...
              <div className="bg-emerald-500/10 border border-emerald-500/30 rounded-lg p-4 mt-6">
                <h4 className="font-semibold mb-2 text-emerald-100">QR Code Security</h4>
                <p className="text-sm text-slate-200/80">QR codes generated by Event Karma contain short-lived, non-PII tokens. Email addresses are not embedded in QR codes. Tokens expire within minutes and cannot be used to identify individuals without server-side verification.</p>
              </div>
            </div>
